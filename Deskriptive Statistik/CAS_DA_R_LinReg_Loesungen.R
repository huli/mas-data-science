...
# Hier geht es nicht um die Prognose eines durchschnittlichen, sondern einzelnen Gewichts!
...
# Das erwartete, durchschnittliche Gewicht bei 200 liegt zwischen 3.37 und 4.06t
...
predict(model, data.frame(hp = 200), interval = "predict", 
        level = .95)
# Das erwartete Gewicht bei 200 liegt zwischen 2.15 und 5.29t
