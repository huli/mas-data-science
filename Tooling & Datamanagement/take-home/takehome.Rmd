...
# todos:
# - ev. mit data.table?
# regression interpretieren, resp. dann wohl für zweites Modell mit relavanten Abhängigkeiten das autoplot machen
# ggfortify elinieren oder ergänzen
# ev. Summaries entfernen
# warnings durchschauen
...
```{r code-ebay-auktionen-2, echo=TRUE, warning=FALSE, message=FALSE, prompt=FALSE}
...
**Interpretation**  
Modell 2 zeigt eine Abhaenigkeit von Miniaturansicht und Preis. 
...
***
**Anmerkung**  
Obwohl in den Vorgaben in der Tabelle die Min-Messung mit 3 ausgegeben ist, habe ich entschieden dies nicht zu machen. Aus meiner Sicht macht es keinen Sinn, bei dieser Messung dann die Dezimalstellen nicht auszugeben (Einheitlichkeit mit 7.400 etc.).